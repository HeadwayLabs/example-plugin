...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".options-tabs-tabs > a", function() {
            ...
            localStorage.setItem('activeTab'+parentPostBox, target);
            localStorage.setItem('parentPostBox'+parentPostBox, parentPostBox);
    ...
    $(window).load(function() {
        setTimeout(function() {
            ...
            // store active tabs to localstorage or add to first tab if no local value 
				$(".wrap").find(".options-postbox").each(function(index, el) {
					var parentPostBox = $(this).attr('id');
	            var activeTab = localStorage.getItem('activeTab'+parentPostBox);
            	var parentPostBox = localStorage.getItem('parentPostBox'+parentPostBox);
